...
function ParticipantInformationRoutineBegin(snapshot) {
  return async function () {
    ...
    ParticipantInformationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RTCalib_promptRoutineBegin(snapshot) {
  return async function () {
    ...
    RTCalib_promptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RTCalib_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    RTCalib_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function comprehensiontrainingloopLoopBegin(comprehensiontrainingloopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    comprehensiontrainingloop.forEach(function() {
...
function TrainingTrialsLoopBegin(TrainingTrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    TrainingTrials.forEach(function() {
...
function CheckPhaseTrialsLoopBegin(CheckPhaseTrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    CheckPhaseTrials.forEach(function() {
...
function comprehensionloopLoopBegin(comprehensionloopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    comprehensionloop.forEach(function() {
...
function MainExpTrialsLoopBegin(MainExpTrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    MainExpTrials.forEach(function() {
...
function RT_Condition_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    RT_Condition_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RT_CalibRoutineBegin(snapshot) {
  return async function () {
    ...
    RT_CalibComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RT_WarningTextRoutineBegin(snapshot) {
  return async function () {
    ...
    RT_WarningTextComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RT_EndRoutineBegin(snapshot) {
  return async function () {
    ...
    RT_EndComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TrainingPromptRoutineBegin(snapshot) {
  return async function () {
    ...
    TrainingPromptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionTraining1RoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionTraining1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionTraining2RoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionTraining2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionTraining3RoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionTraining3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionTrainingFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionTrainingFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TrainingFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    TrainingFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TrainingCreditsRoutineBegin(snapshot) {
  return async function () {
    ...
    TrainingCreditsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TrainingEndRoutineBegin(snapshot) {
  return async function () {
    ...
    TrainingEndComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhasePromptRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhasePromptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhaseInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhaseInstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhaseRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhaseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhaseFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhaseFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function nRepsRoutineBegin(snapshot) {
  return async function () {
    ...
    nRepsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhaseFailRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhaseFailComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckPhaseEndRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckPhaseEndComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MainPromptRoutineBegin(snapshot) {
  return async function () {
    ...
    MainPromptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MainInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    MainInstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MainInstructions2RoutineBegin(snapshot) {
  return async function () {
    ...
    MainInstructions2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionCheckMain1RoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionCheckMain1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ComprehensionCheckMain2RoutineBegin(snapshot) {
  return async function () {
    ...
    ComprehensionCheckMain2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function comprehensionresultRoutineBegin(snapshot) {
  return async function () {
    ...
    comprehensionresultComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MainExpRoutineBegin(snapshot) {
  return async function () {
    ...
    MainExpComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MainExpFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    MainExpFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TimedOutTrialsRoutineBegin(snapshot) {
  return async function () {
    ...
    TimedOutTrialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RecoveryRoutineBegin(snapshot) {
  return async function () {
    ...
    RecoveryComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RecoveryFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    RecoveryFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TotalCreditsRoutineBegin(snapshot) {
  return async function () {
    ...
    TotalCreditsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
